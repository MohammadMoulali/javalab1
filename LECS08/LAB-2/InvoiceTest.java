...
class Invoice
{
	...
	String part_num; String part_des;
	int no_of_items;
	...
	{
		price_of_items=price; return price_of_items;
	}
	public double getInvoiceAmount()
	{
		amount=price_of_items*no_of_items; amount=(amount>0)?amount:0; return amount;
	}
...
class InvoiceTest
{
	...
	{
		BufferedReader	br=new	BufferedReader(new InputStreamReader(System.in));
		Invoice inv1=new Invoice(); inv1.get_part_num(); inv1.get_part_des(); inv1.get_no_of_items(); inv1.get_price_of_items(); 		inv1.getInvoiceAmount();
		System.out.println("	");
		inv1.displayInfo();
	}
}